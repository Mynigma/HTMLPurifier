...
@interface HTMLPurifier_ConfigTest : HTMLPurifier_Harness
{
    HTMLPurifier_ConfigSchema* schema;
}
@end

@implementation HTMLPurifier_ConfigTest

- (void)setUp
{
    [super createCommon];
    [super setUp];
    schema = [HTMLPurifier_ConfigSchema new];
...
- (void)disabled_testBasic
{
    ...
    [super.config setString:key object:input];

    NSString* result = (NSString*)[super.config get:key];
